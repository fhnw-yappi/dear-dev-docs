...
Flow-Zustand. Unzufriedenheit hingegen unterbricht diesen Flow, was zu Frustration führt und Schwierigkeiten führt,
...
\section{Calendar Companion}
  ...
  \subsection{Yappi Chrome Extension}
    ...
    \subsubsection{Benutzeroberfläche (UI)}
        ...
        \textbf{Popup-Ansicht} \\
            Die Abbildung~\ref{fig:yappi-extension-popup} zeiggt das Browser-Popup. Dieses dient als Haupt-UI der
...
\section{Deployment und CI/CD}
    ...
    bereitgestellt wird. So kann gewährleistet werden das dieses Testing unter möglichst realitätsnahen Bedingungen stattfinden
    kann.
