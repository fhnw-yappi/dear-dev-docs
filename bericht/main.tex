...
einer Aufgabe im Gleichgewicht mit den Fähigkeiten des Entwicklers stehen, wodurch Entwicklerinnen und Entwickler
...
des Flows wurden als typische Folgen von negativer Stimmung genannt. Unzufriedene Entwickler berichten von langen Verzögerungen
...
Entwickler zeigen bessere Problemlösungsfähigkeiten, höhere Konzentration, berichten von einem anhaltenden Flow Zustand und
lernen schneller. Die Ergebnisse legen nahe, dass Zufriedenheit die Codequalität begünstigt. Zufriedene Entwickler treffen
sorgfältigere langfristige Entscheidungen. Ein Teilnehmer beschrieb, er dokumentiert seinen Code gründlicher und achtet
...
20\% der Entwickler als wirklich zufrieden in ihrem Job, während etwa 80\% unzufrieden oder \glqq gelassen\grqq{} (complacent) sind. Diese Zahl
...
nicht aus seinem Arbeitsfluss herausgerissen wird. Geeignete Zeitpunkte sind Beispielsweise:
...
Das IntelliJ-Plugin erfüllt das Ziel \textbf{\hyperref[Z1]{Z-1}}, indem es Entwickler unmittelbar nach einem Commit zur Eingabe von Zufriedenheitsdaten auffordert.
  ...
  \subsection{Yappi Chrome Extension}
    ...
    \subsubsection{Benutzeroberfläche (UI)}
        ...
        \textbf{Systembenachrichtigungen} \\
            Beim Ende eines Events im Kalender des Benutzer, erzeugt die Extension eine native Systembenachrichtigung. Die 
