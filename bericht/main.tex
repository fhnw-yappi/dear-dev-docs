...
Yappi ist eine Plattform zur kontinuierlichen Erfassung von Entwicklerzufriedenheit. Diese Arbeit erweitert Yappi
um Integrationen, die Stimmungsdaten nahtlos erheben und mit Meeting- sowie Gesundheitskontext verknüpfen. Umsetzungen umfassen
ein IDE-Plugin mit Post-Commit-Abfrage, eine Kalenderintegration rund um Besprechungen, eine Browser-Erweiterung für zeitnahe
Rückmeldungen sowie einen iOS-App zur Nutzung von Gesundheitsdaten. Ein Backend mit API-Key-Authentifizierung verarbeitet und
persistiert die Daten und bildet eine skalierbare Grundlage für Analysen und künftige Handlungsempfehlungen. Formative
Evaluationen zeigen hohe Akzeptanz für wenig unterbrechende, direkt in Tools integrierte Interaktionen und bestätigen die
technische Machbarkeit der Kontextverknüpfung. Die Arbeit liefert damit eine funktionsfähige Basis für eine kontinuierliche und
nutzerfreundliche Messung von Entwicklerzufriedenheit.

\par\smallskip\noindent\textbf{Schlüsselwörter: } Entwicklerzufriedenheit; Zufriedenheitsmessung; Yappi; Flow; Meetingqualität;
IDE-Plugin; Kalenderintegration; Browser-Erweiterung; Apple HealthKit; Gesundheitsdaten; API-Key-Authentifizierung; Agile Teams.
...
\begin{enumerate}[label=\Alph*.]
  \item Durch welche Technologien und Schnittstellen kann Yappi erweitert werden,
        ...
        \begin{enumerate}[label=\alph*.]
          \item Entwicklung von Tools, die nahtlos in bestehende Arbeitsumgebungen
  ...
  \item Wie können Gesundheitsdaten in die Auswertung der Entwicklerzufriedenheit einfliessen?
        ...
        \end{enumerate}
  \item Wie kann Yappi Entwicklerinnen, Entwickler und Teams dabei unterstützen, aus den erfassten
        Zufriedenheitsdaten, Handlungsempfehlungen abzuleiten und so die Zufriedenheit und Produktivität
        von Entwicklerinnen und Entwickler zu erhöhen?
        \begin{enumerate}[label=\alph*.]
          \item Entwicklung eines Yappi Coach, der anhand einer detaillierten Analyse der erfassten
                ...
                Sitzungen die Zufriedenheit und Konzentration der Entwicklerinnen und Entwickler negativ beeinflussen können.
          \item Integration von KI-gestützten Diensten, die auf Basis der gesammelten Gesundheitsdaten
                ...
                die Arbeitsbedingungen und die Effizienz der Entwicklerinnen und Entwickler nachhaltig zu verbessern.
        \end{enumerate}
\end{enumerate}
...
organisiert. Eine lauffähige Instanz steht zu Beginn dieses Projekts nicht zur Verfügung. Die Zielgruppe ist klar beschrieben. 
...
\begin{description}
  ...
  \item[Frontend] Das Frontend basiert auf React und Next.js mit TypeScript. Für Aufrufe werden SWR-Hooks verwendet, dabei handelt
    es sich um eine React-Library zum Laden von Daten. Komponenten werden mit der Library shadcn/ui aufgebaut. Die 
...
\begin{enumerate}
  \item \textbf{Recherche- und Analysephase:} 
    \begin{itemize}
      ...
      \item \textbf{KI-gestützte Tools (z.\,B. ChatGPT):} Nutzung zur schnellen Exploration von Ideen und Einholung komprimierter
        Literaturübersichten. Ergebnisse wurden immer manuell überprüft und mit Primärquellen validiert. Zusätzlich wurden 
        KI-gestützte Tools verwendet, um Texte hinsichtlich Sprache und Rechtschreibung zu überprüfen.
    \end{itemize}
...
Zufriedene Entwicklerinnen und Entwickler empfinden demnach mehr Arbeitsfreude und Inhaltlichkeit in ihrer Rolle, was eng mit
...
Flow einen Zustand von völliger Vertiefung und hohen Fokus beim Programmieren. Flow tritt auf, wenn die Anforderungen
einer Aufgabe im Gleichgewicht mit den Fähigkeiten der Entwicklerinn oder dem Entwickler stehen, wodurch sie
in einen Zustand von intensiver Konzentration gelangt. Zufriedene Entwickler gelangen einfacher in einen anhaltenden
Flow Zustand. Unzufriedenheit hingegen unterbricht diesen Flow, was zu Frustration führt und Schwierigkeiten bereitet,
nach Unterbrechungen wieder in eine Aufgabe zurückzufinden. Teilnehmende einer Untersuchung  berichten, dass negative 
Erlebnisse einen aus dem Flow Zustand reissen und es erschwert, die Arbeit wieder aufzunehmen~\cite{sadowski_happiness_2019}.

Motivation und Zufriedenheit hängen eng zusammen, sind aber konzeptionell unterscheidbar. Motivierte Entwicklerinnen und Entwickler sind
...
die Voraussetzung von Motivation, zufriedenere Entwicklerinnen und Entwickler weisen in der Regel eine höhere Antriebskraft auf, was wiederum ihre
...
Umgekehrt können toxische Kulturen oder ständig wechselnde Prioritäten die Zufriedenheit und Motivation untergraben, was sich
negativ auf die Leistung auswirkt~\cite{sadowski_happiness_2019}.
...
In den letzten Jahren haben zahlreiche Studien den Zusammenhang zwischen der Entwicklerzufriedenheit und Erfolgsparametern wie
...
Entwicklerinnen und Entwickler innerhalb einer bestimmten Zeit funktionierende und qualitativ hochwertige Softwareartefakte erstellen. Codequalität
...
Bei einer grossangelegten Studie wurden 317 Softwareentwickler befragt und dabei 42 Konsequenzen von Unzufriedenheit sowie
...
des Flows wurden als typische Folgen von negativer Stimmung genannt. Unzufriedene Entwicklerinnen und Entwickler berichten von langen Verzögerungen
oder Qualitätsproblemen, weil Frustration sie aus dem Konzept brachte. Zufriedenheit hingegen wirkt sich positiv aus: Zufriedene
Entwicklerinnen und Entwickler zeigen bessere Problemlösungsfähigkeiten, höhere Konzentration, berichten von einem anhaltenden Flow Zustand und
lernen schneller. Die Ergebnisse legen nahe, dass Zufriedenheit die Codequalität begünstigt. Zufriedene Entwicklerinnen und Entwickler treffen
sorgfältigere langfristige Entscheidungen. Ein Teilnehmerinnen und Teilnehmer beschrieb, er dokumentiert seinen Code gründlicher und achtet
...
20\% der Entwicklerinnen und Entwickler als wirklich zufrieden in ihrem Job, während etwa 80\% unzufrieden oder \glqq gelassen\grqq{} (complacent) sind. Diese Zahl
...
Eine Untersuchung von Zenhub kam zu ähnlichen Ergebnissen: Zwar gaben die meisten befragten Entwicklerinnen und Entwickler an, überwiegend zufrieden
...
Codequalität und Personalbindung hat. Zufriedene Entwicklerinnen und Entwickler arbeiten effizienter, treffen sorgfältigere Entscheidungen und bleiben
...
physiologische und gesundheitsbezogene Parameter in den Fokus der Forschung zur Entwicklerzufriedenheit. Studien aus der
Arbeitspsychologie und der Human Factors-Forschung belegen einen messbaren Einfluss der körperlichen und mentalen Gesundheit auf
die Arbeitsleistung. Dieser Einfluss betrifft insbesondere kognitive Fähigkeiten, emotionale Stabilität und Motivation. Besonders
in wissensintensiven Berufen, die ein hohes Mass an Konzentration benötigen, wie der Softwareentwicklung können selbst moderate
Abweichungen vom optimalen Gesundheitszustand die Arbeitsleistung und das subjektive Wohlbefinden deutlich beeinflussen.
...
besserer Codequalität und stärkerer Mitarbeiterbindung einhergeht~\cite{graziotin_what_2018, sadowski_happiness_2019}, ist die
Kausalität bislang nicht eindeutig geklärt. Unklar bleibt, ob hohe Zufriedenheit die Produktivität steigert oder ob
...
\begin{description}
  \item[Officevibe:] Ein Software-as-a-Service-Tool, das wöchentliche Pulse-Umfragen an Mitarbeitende verschickt. Ziel ist es,
    ...
    das Engagement von Mitarbeiterinnen und Mitarbeiter ausgerichtet und liefert keine speziell auf Entwicklerinnen und Entwickler zugeschnittenen Kontextdaten, z.B. werden keine
  ...
  \item[TeamMood:] Ein schlankes Stimmungsbarometer für Teams, das täglich eine einfache Mood-Abfrage durchführt. TeamMood sendet
    ...
    dass Entwicklerinnen und Entwickler die Stimmungsverläufe selbst interpretieren und Massnahmen ableiten müssen, ohne direkte
  ...
  \item[Happimeter:] Hervorgegangen aus einem Forschungsprojekt (u.a. TU Wien und MIT) setzt Happimeter auf Wearable Sensoren, um
    einen persönlichen Happiness-Score zu bestimmen. Entwicklerinnen und Entwickler tragen z.B. eine Smartwatch mit der Happimeter-App, die
  ...
  \item[Code Climate Velocity:] Code Climate Velocity: Eine Datenplattform, die Entwicklungsmetriken aus Git-Repositories analysiert,
    ...
    menschliche Stimmungslage der Entwicklerinnen und Entwickler wird nicht erfasst. Etwaige Einflüsse von Motivation oder Frustration auf die
  ...
  \item[GitHub Insights:] Als integrierter Teil von GitHub bietet Insights grundlegende Analysen zur Repository-Aktivität. In jedem
    ...
    Stimmungsbild der Entwicklerinnen und Entwickler aus. Etwa ob eine Phase hoher Commit-Rate auf Überstunden und Stress zurückzuführen ist, bleibt
  ...
  \item[Microsoft Viva Insights:] Viva Insights ist Teil von Microsoft 365 und zielt darauf ab, durch Analyse von Arbeitsmustern die
    ...
    Kommunikationsdaten aus (z.B. E-Mail- und Teams-Nutzung, Meeting-Häufigkeit). Entwicklerinnen und Entwickler erhalten z.B. Hinweise, wenn
    ...
    Gefühlslage oder ein Bezug zu konkreten Tätigkeiten von Entwicklerinnen und Entwicklern (Code, Tickets etc.) fehlt vollständig. Somit bleibt die
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{0.25\textwidth}|X}
    ...
    bei der eine Entwicklerin oder ein Entwickler von sich aus eine Rückmeldung abgeben muss \\ \hline
...
Ein relevanter Zeitpunkt zur Aufforderung zur Erfassung von Zufriedenheitsdaten sollte so gewählt werden, dass Entwicklerinnen und
Entwickler nicht aus ihrem Arbeitsfluss herausgerissen werden. Geeignete Zeitpunkte sind Beispielsweise:
...
\begin{itemize}
  \item \textbf{Nach einem Commit:} Entwicklerinnen und Entwickler übermitteln im Arbeitsalltag regelmässig ihre vorgenommenen
    ...
    daher, um eine kurze Rückmeldung zu erfassen, ohne die Entwicklerin oder den Entwickler aus einer konzentrierten Arbeitssituation herauszureissen.
...
Als letzter Bestandteil der Erweiterung wertet der Yappi Coach die erfassten Daten automatisiert aus. Ziel ist es, nicht nur 
...
\begin{enumerate}
  \item \textbf{Ganzheitlichkeit vor Fragmentierung:} Zufriedenheitswerte werden stets im Kontext weiterer relevanter Faktoren 
    betrachtet.
...
\subsection{Z-1: Automatisierte Aufforderung zur Zufriedenheitserfassung}\label{Z1}
...
\subsection{Z-2: Erfassung der Meetingqualität}\label{Z2}
...
\subsection{Z-3: Verknüpfung mit Kontext- und Gesundheitsdaten}\label{Z3}
...
\subsection{Z-3: Automatisierte Interpretation und Handlungsempfehlungen (Yappi Coach)}\label{Z4}
...
Die Bewertung erfolgte mit einer Likert-Skala von 0 bis 10, wobei 0 \glqq sehr unwichtig\grqq{} und 10 \glqq sehr wichtig\grqq{} 
bedeutet. Eine Likert-Skala ist ein in der Sozialforschung weit verbreitetes Verfahren, bei dem Teilnehmende ihre Zustimmung
...
Dies zeigt, dass direkte Integrationen wie das IntelliJ-Plugin besonders relevant sind. Niedrige Werte bei Freitextkommentaren
weisen darauf hin, dass Funktionen mit hohem manuellem Aufwand weniger Akzeptanz finden. Daraus ergibt sich die Priorisierung
automatisierter Erfassungen.
...
Authentifizierung einzelner Nutzerinnen und Nutzer in interaktiven Sitzungen. Sie erfordern in der Regel eine vorgelagerte Benutzeranmeldung und
...
Der API-Key-Mechanismus wurde entwickelt, um diesen Anforderungen gerecht zu werden. Jede Nutzerin und jeder Nutzer verfügt über einen persönlichen
...
Die Implementierung des API-Key-Mechanismus dient als technische Grundlage für die Ziele \textbf{\hyperref[Z1]{Z-1}} und 
\textbf{\hyperref[Z3]{Z-3}}, da sie externe Module sicher mit Yappi verbindet und den Datenaustausch ermöglicht.
...
Anstelle von Anmeldedaten verwenden Clients einen statisch generierten API-Key, der für jeweilige Nuterinnen und Nutzer erstellt und ausschliesslich diesem zugeordnet ist.
...
Die Speicherung des rohen API-Keys (\texttt{raw\_key}) dient ausschliesslich dem Zweck, diesen Nutzerinnen und Nutzer nach der Erstellung 
...
berechtigte Nutzerinnen und Nutzer einen Schlüssel anlegen können. Zur Übertragungssicherheit wird der API-Key ausschliesslich über verschlüsselte
...
Datenbankzugriff unbefugten Gebrauch zu verhindern. Ein kompromittierter API-Key kann jederzeit durch die Nutzerin oder den Nutzer
gesperrt oder durch einen neuen ersetzt werden.
...
Der Prozess beginnt mit der einmaligen Generierung des API-Keys durch die Nutzerin oder den Nutzer in der Webanwendung. Nach der Erstellung wird der
...
\begin{itemize}
  ...
  \item \texttt{POST /apikey/generate} \\
        Erzeugt einen neuen API-Key für eine Nutzerin oder einen Nutzer und gibt den API-Key zurück. \\
...
nahtlos in die bestehende IntelliJ-Oberfläche integriert werden, ohne den gewohnten Workflow der Entwicklerinnen und Entwickler zu unterbrechen.
...
zu erfassen. Ziel ist es, die Erfassung von Stimmungsdaten möglichst nahtlos in den Workflow von Entwicklerinnen und Entwickler zu integrieren, ohne den
...
die Entwicklerin oder der Entwickler seine Stimmung zum Commit angeben kann. Diese Daten werden anschliessend an Yappi übertragen und dort gespeichert.

Das IntelliJ-Plugin erfüllt das Ziel \textbf{\hyperref[Z1]{Z-1}}, indem es Entwicklerinnen und Entwickler unmittelbar nach einem Commit zur Eingabe von Zufriedenheitsdaten auffordert.

\subsection{Architektur und Integration}

Die Abbildung~\ref{fig:intellij-system-diagram} zeigt den Aufbau des Yappi IntellJ IDEA Companion.
...
Dialog öffnet sich als eigenständiges Fenster und blockiert die IDE nicht, sodass Entwicklerinnen und Entwickler sofort weiterarbeiten können. Die
...
\begin{itemize}
  \item \textbf{Commit Message:} Im oberen Bereich wird die soeben erfasste Commit Message angezeigt.
...
Hintergrund ab, sodass Entwicklerinnen und Entwickler direkt mit ihrer Arbeit fortfahren können.
...
Der Controller \texttt{IntellijCompanionController} stellt den Endpoint, über den die Zufriedenheitsdaten und commit-spezifischen
...
\texttt{context\_type} & TEXT & Die Art von Kontextinformation die gespeichert wird (z.B. Commit Message oder Number of Lines 
  Changed) \\
\texttt{value} & TEXT & Der Wert welcher gespeichert wird. Z.B. die Commit Message, wie sie in IntelliJ beim Commit eingegeben
  wurde \\
...
\section{Calendar Companion}
        ...
        Zur automatischen Erkennung relevanter Meetings werden Kalendersysteme von Entwicklerinnen und Entwickler angebunden.
        ...
        Das Konzept sieht vor, dass Nutzerinnen und Nutzer in Yappi auf ihrem Profil den Zugriff auf den Kalender hinterlegen können.
        Regelmässig werden die  Kalendereinträge von Nutzerinnen und Nutzer in die Datenbank synchronisiert.
        Auf dieser Basis kann die Anwendung automatisch identifizieren, wann ein Meeting stattfindet.
        Dadurch lassen sich Feedback-Anfragen unmittelbar nach dem Ende einer Besprechung auslösen, ohne dass Nuterinnen und Nutzer manuell eingreifen müssen.

        Die Synchronisation des Kalenders erfolgt ausschliesslich lesend, um Eingriffe in persönliche Kalender zu vermeiden.
        ...
        Informationen zu Kalendereinträge sind nur für die Nutzerin oder den Nutzer persönlich einsehbar.

        Durch diese Anbindung entfällt das manuelle Erfassung von Kalendereinträgen. Meetings werden automatisch erkannt,
        Änderungen übernommen und die Nutzerinnen und Nutzer benachrichtigt. So entsteht ein nahtloser integrierter Feedback Flow um die
        Zufriedenheitsdaten von Meetings für die Entwicklerinnen und Entwickler zu erheben.
        ...
        Der Calendar Companion setzt das Ziel \textbf{\hyperref[Z2]{Z-2}} um, indem er nach Abschluss relevanter Meetings
        automatisch eine Bewertung zur Meetingqualität anfordert.
  ...
  \subsection{Yappi Chrome Extension}
      ...
      Zeitpunkt zu ermöglichen. Nach dem Ende eines im Kalender erfassten Meetings erhält die Nutzerin oder der Nutzer eine Benachrichtigung,
    ...
    \subsubsection{Komponenten im Detail}
        \textbf{Background-Prozess (\texttt{background/background.js})} \\
            ...
            \begin{itemize}
              \item Aufbau und Aufrechterhaltung einer Websockets-Verbindung

              (über \texttt{lib/mqtt.js}) zum Yappi Kommunikationsbroker.
              \item Abonnieren der benutzerspezifischen Topics zur Echtzeitbenachrichtigung

              (\texttt{companion/event/calendar/*user-token*}).
              \item Verarbeitung eingehender Nachrichten und Erzeugung nativer Desktop-Benachrichtigungen

              (\texttt{chrome.notifications}).
              \item Persistente Speicherung der letzten zehn Ereignisse in

              \texttt{chrome.storage.local} nach FIFO-Prinzip.
            \end{itemize}
        ...
        \textbf{Popup-Benutzeroberfläche (\texttt{popup/home.html})} \\
            \begin{itemize}
              \item Dynamischer Umfrage-Builder (\texttt{popup/survey/builder.js}):
                    Ruft aktuelle Umfragen über die REST-API ab, generiert DOM-Elemente aus JSON Vorlagen

                    (\texttt{popup/questionblock.html},
                    \texttt{popup/questionblock.js}) und integriert diese in die Ansicht.
                    Mehr Details dazu in Abschnitt~\ref{dynamische-umfragen}.
    ...
    \subsubsection{Benutzeroberfläche (UI)}
        ...
        \textbf{Systembenachrichtigungen} \\
            Beim Ende eines Events, erzeugt die Extension eine native Systembenachrichtigung. Die 
            Abbildung~\ref{fig:yappi-extension-notification} zeigt diese Systembenachrichtigung unter macOS.
        ...
        \textbf{Popup-Ansicht} \\
            Die Abbildung~\ref{fig:yappi-extension-popup} zeigt das Browser-Popup. Dieses dient als Haupt-UI der
            Extension und wird durch einen Klick auf das Yappi-Icon in der Browser-Toolbar geöffnet.
            ...
            \begin{itemize}
                ...
                \item Aktionsbuttons für jedes Meeting:
                    ...
                    \end{itemize}
            \end{itemize}
            Das Design stellt sicher, dass Nutzerinnen und Nutzer sowohl über Echtzeitbenachrichtigungen als auch über die Popup-Ansicht
    ...
    \subsubsection{Kommunikationskanäle}
        ...
        Abbildung~\ref{fig:communication-calendar-notify} zeigt wie, Kommunikation abläuft, nach Beenden eines Kalender-Events.
...
\subsection{Backend-Integration}
        ...
        Zudem ist es zuständig für das Laden und synchronisieren der externen iCalendar-Daten (ICS) welche von den Nutzerinnen und Nutzer hinterlegt werden.


    \subsubsection{Model-Klasse}
        Die zentrale Datenstruktur bildet die JPA-Entität \texttt{CalendarEvent.java} (\texttt{entities/}).
        Sie repräsentiert einen einzelnen Kalendereintrag mit Attributen wie \texttt{title}, \texttt{startDate}, \texttt{endDate}, \texttt{allDay} sowie der Zuordnung zu einer Nutzerin oder einem Nutzer (\texttt{userId}).
    ...
    \subsubsection{API-Endpunkte (\texttt{CalendarController})}
        ...
        \begin{itemize}
            \item \texttt{GET /api/calendar/\{userId\}}
                Ruft alle Kalendereinträge einer Nutzerin oder eines Nutzers ab.
...
\subsection{Datenbankerweiterung}
    ...
    \subsubsection{Backend-Komponenten}
        \begin{itemize}
            ...
            \item \textbf{Controller} (\texttt{CalendarController.java}): REST-Endpunkte zum Abrufen von Events pro Nutzerin oder Nutzer.
...
\subsection{Dynamische Umfragen}\label{dynamische-umfragen}
    ...
    \subsubsection{Datenbank}
        Die Tabelle \texttt{questionblocks} speichert die Konfiguration einzelner Fragenblöcke. Das zugrunde liegende 
        Datenbankschema ist in der Tabelle~\ref{tab:questionblocks_schema} dargestellt.
...
Der im Rahmen dieses Projekts entwickelte \textit{Health Companion} ist eine iOS-Anwendung, die diese Funktionalität in Yappi
integriert. Sie ermöglicht die automatisierte Erfassung der ausgewählten Gesundheitsmetriken aus Apple HealthKit und überträgt
diese sicher an das Yappi Backend.

Diese Erweiterung adressiert das Ziel \textbf{\hyperref[Z3]{Z-3}}, indem sie Gesundheitsdaten automatisch erfasst und so eine 
fundiertere Analyse der Einflussfaktoren auf die Arbeitszufriedenheit ermöglicht.
...
(\texttt{HKQuantityTypeIdentifier.stepCount}) angefordert wird. Erst nach Bestätigung durch die Nutzerin oder den Nutzer beginnt die App mit der
Erfassung.
...
\begin{description}
  \item \texttt{POST /companion/health} \\
        Nimmt Gesundheitsdaten im definierten JSON-Format entgegen und speichert sie für authentisierten Nutzerinnen und Nutzer. 
...
zunächst, ob für den übermittelte Benutzerinnen und Benutzer und die angegebene Metrik im gesendeten Zeitraum bereits ein Eintrag in der Datenbank
...
lassen sich weitere Gesundheitsmetriken ohne Schemaänderungen hinzufügen. Die Tabelle~\ref{tab:health_metric_schema} zeigt das
Datenbankschema.
...
minimalistisch gehalten und darauf ausgelegt, den API-Key einmalig zu hinterlegen, ohne dass danach weitere Eingaben erforderlich
sind.
...
Yappi übertragen. Dadurch entfällt für Nutzerinnen und Nutzer jede manuelle Auslösung und der Betrieb der App erfordert keine zusätzliche
Interaktion.
...
\section{Deployment und CI/CD}
    ...
    bereitgestellt wird. So kann gewährleistet werden dass dieses Testing unter möglichst realitätsnahen Bedingungen stattfinden
    kann.

    Zudem ermöglicht ein funktionierendes Deployment die Überprüfung der Zusammenarbeit der verschiedenen Companion Apps.
    Nur in einer produktiven Umgebung lässt sich sicherstellen, dass diese Komponenten korrekt miteinander interagieren und Daten
    wie vorgesehen austauschen.
    ...
    Das Deployment- und CI/CD-Setup unterstützt die Umsetzung von den Zielen \textbf{\hyperref[Z1]{Z-1}}, 
    \textbf{\hyperref[Z2]{Z-2}} und \textbf{\hyperref[Z3]{Z-3}}, indem es eine stabile und kontinuierlich aktualisierte Plattform
    bereitstellt.
    ...
    \subsection{NGINX-Proxykonfiguration}
        ...
        Dieser aggregiert dann automatisch zum gewünschten Endpunkt. Das Mapping der Endpunkte sieht wie folgt aus:
    ...
    Mosquitto verwaltet den Nachrichtenaustausch zwischen dem Backend, das über MQTT kommuniziert, und der Chrome Extension, die 
    zwingendermassen Websockets verwendet,
...
\section{Beantwortung der Fragestellung}
    ...
    \textit{Wie kann Yappi Teams und Entwicklerinnen und Entwickler dabei unterstützen, aus den erfassten Zufriedenheitsdaten
    Handlungsempfehlungen abzuleiten?}
    ...
    \subsection*{Zusammenfassung}
    Die Ziele \textbf{\hyperref[Z1]{Z-1}}, \textbf{\hyperref[Z2]{Z-2}} und \textbf{\hyperref[Z3]{Z-3}} wurden in diesem Projekt
    vollständig oder prototypisch umgesetzt, womit die Forschungsfragen (Kapitel~\ref{fragestellungen}) A und B beantwortet
    werden können. Die Forschungsfrage C wurde konzeptionell beantwortet, eine praktische Umsetzung ist als nächster
    Entwicklungsschritt vorgesehen. Insgesamt trägt die Arbeit zur Verbesserung der kontinuierlichen, kontextbezogenen und
    nutzerfreundlichen Erfassung von Entwicklerzufriedenheit bei.
...
Die vorliegende Arbeit baut auf der Bachelor-Thesis "What do you think, dear develope auf, deren Ziel es war, Yappi
...
\renewcommand{\thesection}{\Alph{section}}
    ...
    \section{Verlinkungen}
        ...
        Alle Änderungen im Backend und Frontend befinden sich auf dem Branch \glqq develop\grqq{}
        ...
        Alle Companion Apps befinden sich jeweils dem Branch \glqq main\grqq{}
