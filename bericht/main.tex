...
\begin{description}
  ...
  \item[Frontend] Das Frontend basiert auf React und Next.js mit TypeScript. Für Aufrufe werden SWR-Hooks verwendet, dabei handelt
    es sich ume eine React-Library zum Laden von Daten. Komponenten werden mit der Library shadcn/ui aufgebaut. Die 
...
einer Aufgabe im Gleichgewicht mit den Fähigkeiten des Entwicklers stehen, wodurch man in einen Zustand von intensiver 
...
treffen sorgfältigere langfristige Entscheidungen. Ein Teilnehmer beschrieb, er dokumentiert seinen Code gründlicher und achtet
